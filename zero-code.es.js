...
var Yr = (e, o, t) =>
  o in e
    ? Xr(e, o, { enumerable: !0, configurable: !0, writable: !0, value: t })
    : (e[o] = t);
var _t = (e, o, t) => Yr(e, typeof o != "symbol" ? o + "" : o, t);
import {
  defineComponent as _e,
  computed as de,
  toRefs as fr,
  unref as G,
  ref as ne,
  ...
  withModifiers as He,
  createBlock as Be,
  withDirectives as Oe,
  vModelText as Xe,
  vModelSelect as gr,
  createTextVNode as jt,
  onBeforeUnmount as Jr,
  renderSlot as qr,
  normalizeStyle as Gr,
  defineCustomElement as Qr,
} from "vue";
var en = Object.defineProperty,
  ...
  Vo = (e, o, t) =>
    o in e
      ? en(e, o, { enumerable: !0, configurable: !0, writable: !0, value: t })
      : (e[o] = t),
  $t = (e, o) => {
    for (var t in o || (o = {})) hr.call(o, t) && Vo(e, t, o[t]);
    if (Gt) for (var t of Gt(o)) vr.call(o, t) && Vo(e, t, o[t]);
    return e;
  },
  yr = (e, o) => {
    var t = {};
    for (var r in e) hr.call(e, r) && o.indexOf(r) < 0 && (t[r] = e[r]);
    if (e != null && Gt)
      for (var r of Gt(e)) o.indexOf(r) < 0 && vr.call(e, r) && (t[r] = e[r]);
    return t;
  };
function Zo(e, o, t) {
...
function an(e, o = document) {
  ...
  let r = null;
  return (
    typeof (o == null ? void 0 : o.querySelector) == "function"
      ? (r =
          (t = o == null ? void 0 : o.querySelector) == null
            ? void 0
            : t.call(o, e))
...
var nt = ot(/(?:Trident.*rv[ :]?11\.|msie|iemobile|Windows Phone)/i),
  Ft = ot(/Edge/i),
  Ko = ot(/firefox/i),
  Tt = ot(/safari/i) && !ot(/chrome/i) && !ot(/android/i),
  br = ot(/iP(ad|od|hone)/i),
  $r = ot(/chrome/i) && ot(/android/i),
  wr = {
    capture: !1,
    passive: !1,
  };
...
function Qt(e, o) {
  if (o) {
    if ((o[0] === ">" && (o = o.substring(1)), e))
      try {
        if (e.matches) return e.matches(o);
        if (e.msMatchesSelector) return e.msMatchesSelector(o);
        if (e.webkitMatchesSelector) return e.webkitMatchesSelector(o);
      } catch {
        return !1;
      }
    return !1;
...
function Ue(e, o, t, r) {
  if (e) {
    ...
    do {
      if (
        (o != null &&
          (o[0] === ">" ? e.parentNode === t && Qt(e, o) : Qt(e, o))) ||
        (r && e === t)
      )
        return e;
      if (e === t) break;
...
function Ne(e, o, t) {
  if (e && o)
    if (e.classList) e.classList[t ? "add" : "remove"](o);
    else {
      var r = (" " + e.className + " ")
        .replace(Jo, " ")
        .replace(" " + o + " ", " ");
...
function W(e, o, t) {
  ...
  if (r) {
    ...
    !(o in r) && o.indexOf("webkit") === -1 && (o = "-webkit-" + o),
      (r[o] = t + (typeof t == "string" ? "" : "px"));
  }
}
function zt(e, o) {
  var t = "";
...
function zr(e, o, t) {
  if (e) {
    var r = e.getElementsByTagName(o),
      n = 0,
      m = r.length;
    if (t) for (; n < m; n++) t(r[n], n);
    return r;
  }
  return [];
}
    ...
    if (
      (e !== window && e.parentNode && e !== Ye()
        ...
        : ((v = 0),
          ...
          (w = window.innerWidth)),
      (o || t) && e !== window && ((n = n || e.parentNode), !nt))
    )
      do
        if (
          n &&
          n.getBoundingClientRect &&
          (W(n, "transform") !== "none" || (t && W(n, "position") !== "static"))
        ) {
          var P = n.getBoundingClientRect();
          (v -= P.top + parseInt(W(n, "border-top-width"))),
            (l -= P.left + parseInt(W(n, "border-left-width"))),
            (h = v + m.height),
            (E = l + m.width);
          break;
        }
...
function No(e, o) {
  for (
    ...
    t && (t === X.ghost || W(t, "display") === "none" || (o && !Qt(t, o)));
...
function vn(e, o) {
  for (var t in e)
    if (e.hasOwnProperty(t)) {
      for (var r in o)
        if (o.hasOwnProperty(r) && o[r] === e[t][r]) return Number(t);
    }
  return -1;
}
function lt(e, o) {
  if (!e || !e.getBoundingClientRect) return Ye();
  var t = e,
    r = !1;
  do
    if (t.clientWidth < t.scrollWidth || t.clientHeight < t.scrollHeight) {
      ...
      if (
        ...
        if (!t.getBoundingClientRect || t === document.body) return Ye();
        if (r || o) return t;
        r = !0;
      }
    }
...
function yn(e, o) {
  if (e && o) for (var t in o) o.hasOwnProperty(t) && (e[t] = o[t]);
  return e;
}
function mo(e, o) {
  return (
    Math.round(e.top) === Math.round(o.top) &&
    Math.round(e.left) === Math.round(o.left) &&
    Math.round(e.height) === Math.round(o.height) &&
    Math.round(e.width) === Math.round(o.width)
  );
}
var Dt;
function Ar(e, o) {
  return function () {
    if (!Dt) {
      var t = arguments,
        r = this;
      t.length === 1 ? e.call(r, t[0]) : e.apply(r, t),
  ...
  return (
    Array.from(e.children).forEach(function (n) {
      ...
      if (!(!Ue(n, o.draggable, e, !1) || n.animated || n === t)) {
        var E = ze(n);
        (r.left = Math.min(
          (m = r.left) !== null && m !== void 0 ? m : 1 / 0,
          E.left
        )),
          (r.top = Math.min(
            (v = r.top) !== null && v !== void 0 ? v : 1 / 0,
            E.top
          )),
          (r.right = Math.max(
            (l = r.right) !== null && l !== void 0 ? l : -1 / 0,
            E.right
          )),
          (r.bottom = Math.max(
  ...
  return {
      ...
      e.forEach(function (v) {
        ...
        d && ((A.top -= d.f), (A.left -= d.e)),
          ...
          h.thisAnimationDuration &&
            mo(w, A) &&
            !mo(E, A) && // Make sure animatingRect is on line between toRect & fromRect
            (b.top - A.top) / (b.left - A.left) ===
              (E.top - A.top) / (E.left - A.left) &&
            (l = zn(b, w, P, r.options)),
          mo(A, E) ||
            ((h.prevFromRect = E),
            (h.prevToRect = A),
    ...
    animate: function (t, r, n, m) {
      if (m) {
        ...
        (t.animatingX = !!E),
          (t.animatingY = !!A),
          W(t, "transform", "translate3d(" + E + "px," + A + "px,0)"),
          (this.forRepaintDummy = wn(t)),
          W(
            t,
            "transition",
            "transform " +
          ...
          W(t, "transform", "translate3d(0,0,0)"),
...
function zn(e, o, t, r) {
  return (
    (Math.sqrt(Math.pow(o.top - e.top, 2) + Math.pow(o.left - e.left, 2)) /
...
var vt = [],
  ...
  Rt = {
    mount: function (e) {
      for (var o in go) go.hasOwnProperty(o) && !(o in e) && (e[o] = go[o]);
      ...
      return (
        vt.forEach(function (r) {
          typeof r.eventProperties == "function" &&
            rt(t, r.eventProperties.call(o[r.pluginName], e));
        }),
        t
      );
    },
    modifyOption: function (e, o, t) {
      ...
      return (
        vt.forEach(function (n) {
          e[n.pluginName] &&
            n.optionListeners &&
            typeof n.optionListeners[o] == "function" &&
            (r = n.optionListeners[o].call(e[n.pluginName], t));
        }),
        r
      );
    },
...
function An(e) {
  var o = e.sortable,
    ...
    h = e.oldIndex,
    E = e.newIndex,
    A = e.oldDraggableIndex,
    w = e.newDraggableIndex,
    P = e.originalEvent,
    b = e.putSortable,
    d = e.extraEventProperties;
  if (((o = o || (t && t[Me])), !!o)) {
    var s,
      f = o.options,
      a = "on" + r.charAt(0).toUpperCase() + r.substr(1);
    window.CustomEvent && !nt && !Ft
      ? (s = new CustomEvent(r, {
          bubbles: !0,
          cancelable: !0,
        }))
      ...
      (s.oldIndex = h),
      (s.newIndex = E),
      (s.oldDraggableIndex = A),
      (s.newDraggableIndex = w),
      (s.originalEvent = P),
      (s.pullMode = b ? b.lastPutMode : void 0);
...
var R,
  ...
  Vt = br,
  tr = Ft || nt ? "cssFloat" : "float",
  En = so && !$r && !br && "draggable" in document.createElement("div"),
  Cr = (function () {
    if (so) {
      if (nt) return !1;
  ...
  Sr = function (e, o) {
    var t = W(e),
      ...
      v = n && W(n),
      l = m && W(m),
      h = v && parseInt(v.marginLeft) + parseInt(v.marginRight) + ze(n).width,
      E = l && parseInt(l.marginLeft) + parseInt(l.marginRight) + ze(m).width;
    if (t.display === "flex")
    ...
    if (n && v.float && v.float !== "none") {
      ...
      return m && (l.clear === "both" || l.clear === A)
        ? "vertical"
        : "horizontal";
    }
    return n &&
  ...
  _n = function (e, o, t) {
    var r = t ? e.left : e.top,
      n = t ? e.right : e.bottom,
      m = t ? e.width : e.height,
      v = t ? o.left : o.top,
      l = t ? o.right : o.bottom,
  ...
  Cn = function (e, o) {
    ...
    return (
      to.some(function (r) {
        ...
        if (!(!n || No(r))) {
          var m = ze(r),
            v = e >= m.left - n && e <= m.right + n,
            l = o >= m.top - n && o <= m.bottom + n;
          if (v && l) return (t = r);
        }
      }),
      t
  ...
  Ir = function (e) {
    function o(n, m) {
      return function (v, l, h, E) {
        var A =
          v.options.group.name &&
          l.options.group.name &&
          v.options.group.name === l.options.group.name;
        if (n == null && (m || A)) return !0;
        if (n == null || n === !1) return !1;
        if (m && n === "clone") return n;
        if (typeof n == "function") return o(n(v, l, h, E), m)(v, l, h, E);
        var w = (m ? v : l).options.group.name;
        return (
          n === !0 ||
          (typeof n == "string" && n === w) ||
          (n.join && n.indexOf(w) > -1)
        );
      };
    }
    var t = {},
    ...
    (!r || Ut(r) != "object") &&
      ...
      (t.name = r.name),
      (t.checkPull = o(r.pull, !0)),
      (t.checkPut = o(r.put)),
      (t.revertClone = r.revertClone),
      (e.group = t);
  },
  Tr = function () {
...
function X(e, o) {
  ...
  (this.nativeDraggable = o.forceFallback ? !1 : En),
  ...
  /** @lends Sortable.prototype */
  {
    ...
    _getDirection: function (e, o) {
      return typeof this.options.direction == "function"
        ? this.options.direction.call(this, e, o, R)
    ...
    _onTapStart: function (e) {
      if (e.cancelable) {
        ...
        if (
          ...
          !R &&
            !(
              (/mousedown|pointerdown/.test(m) && e.button !== 0) ||
              r.disabled
            ) &&
            !h.isContentEditable &&
            !(
            ...
            ((l = Ue(l, r.draggable, t, !1)), !(l && l.animated) && Wt !== l))
        ) {
          if (
            ((wt = xe(l)), (Nt = xe(l, r.draggable)), typeof E == "function")
          ) {
          ...
          (r.handle && !Ue(h, r.handle, t, !1)) ||
            this._prepareDragStart(e, v, l);
        }
      }
    },
    _prepareDragStart: function (e, o, t) {
      ...
      if (t && !R && t.parentNode === n) {
        ...
        if (
          ...
          (Qo = pt.clientX - h.left),
          (er = pt.clientY - h.top),
          (this._lastX = (o || e).clientX),
          (this._lastY = (o || e).clientY),
          ...
          (l = function () {
            ...
            r._disableDelayedDragEvents(),
              !Ko && r.nativeDraggable && (R.draggable = !0),
              r._triggerDragStart(e, o),
              Ie({
                sortable: r,
                name: "choose",
                originalEvent: e,
          ...
          se(v, "mousemove", ft),
          se(v, "touchmove", ft),
          se(v, "mouseup", r._onDrop),
          se(v, "touchend", r._onDrop),
          se(v, "touchcancel", r._onDrop),
          Ko &&
            this.nativeDraggable &&
          ...
          m.delay &&
            (!m.delayOnTouchOnly || o) &&
            (!this.nativeDraggable || !(Ft || nt)))
        ) {
          if (X.eventCanceled) {
            this._onDrop();
            return;
          }
          se(v, "mouseup", r._disableDelayedDrag),
            se(v, "touchend", r._disableDelayedDrag),
            se(v, "touchcancel", r._disableDelayedDrag),
            se(v, "mousemove", r._delayedDragTouchMoveHandler),
            se(v, "touchmove", r._delayedDragTouchMoveHandler),
            m.supportPointer &&
              se(v, "pointermove", r._delayedDragTouchMoveHandler),
            (r._dragStartTimer = setTimeout(l, m.delay));
        } else l();
      }
    },
    ...
    _disableDelayedDragEvents: function () {
      ...
      re(e, "mouseup", this._disableDelayedDrag),
        re(e, "touchend", this._disableDelayedDrag),
        re(e, "touchcancel", this._disableDelayedDrag),
        re(e, "mousemove", this._delayedDragTouchMoveHandler),
        re(e, "touchmove", this._delayedDragTouchMoveHandler),
        re(e, "pointermove", this._delayedDragTouchMoveHandler);
    },
    _triggerDragStart: function (e, o) {
      (o = o || (e.pointerType == "touch" && e)),
        !this.nativeDraggable || o
          ...
          : (se(R, "dragend", this), se(fe, "dragstart", this._onDragStart));
      try {
        document.selection
          ? Yt(function () {
    ...
    _emulateDragOver: function () {
      if (je) {
        ...
        for (
          var e = document.elementFromPoint(je.clientX, je.clientY), o = e;
          e &&
          e.shadowRoot &&
    ...
    _onTouchMove: function (e) {
      if (pt) {
        var o = this.options,
          ...
          h = Vt && Se && Go(Se),
          E =
            (n.clientX - pt.clientX + r.x) / (v || 1) +
            (h ? h[0] - yo[0] : 0) / (v || 1),
          A =
            (n.clientY - pt.clientY + r.y) / (l || 1) +
            (h ? h[1] - yo[1] : 0) / (l || 1);
        if (!X.active && !bt) {
          if (
            t &&
    ...
    _appendGhost: function () {
      if (!K) {
        var e = this.options.fallbackOnBody ? document.body : fe,
          o = ze(R, !0, Vt, !0, e),
          t = this.options;
        if (Vt) {
          for (
            Se = e;
            W(Se, "position") === "static" &&
            W(Se, "transform") === "none" &&
            Se !== document;

          )
            Se = Se.parentNode;
          Se !== document.body && Se !== document.documentElement
            ? (Se === document && (Se = Ye()),
              (o.top += Se.scrollTop),
              (o.left += Se.scrollLeft))
            : (Se = Ye()),
            (yo = Go(Se));
        }
        (K = R.cloneNode(!0)),
          Ne(K, t.ghostClass, !1),
          Ne(K, t.fallbackClass, !0),
          Ne(K, t.dragClass, !0),
          W(K, "transition", ""),
          W(K, "transform", ""),
          W(K, "box-sizing", "border-box"),
          W(K, "margin", 0),
          W(K, "top", o.top),
          W(K, "left", o.left),
          W(K, "width", o.width),
          W(K, "height", o.height),
          W(K, "opacity", "0.8"),
          W(K, "position", Vt ? "absolute" : "fixed"),
          W(K, "zIndex", "100000"),
          ...
          W(
            K,
            "transform-origin",
            (Qo / parseInt(K.style.width)) * 100 +
              "% " +
              (er / parseInt(K.style.height)) * 100 +
              "%"
          );
      }
    },
    _onDragStart: function (e, o) {
      ...
      De("setupClone", this),
        X.eventCanceled ||
          ((he = Er(R)),
          he.removeAttribute("id"),
          (he.draggable = !1),
          (he.style["will-change"] = ""),
          this._hideClone(),
          Ne(he, this.options.chosenClass, !1),
          (X.clone = he)),
        (t.cloneId = Yt(function () {
          De("clone", t),
            !X.eventCanceled &&
              (t.options.removeCloneOnHide || fe.insertBefore(he, R),
              t._hideClone(),
              Ie({
                sortable: t,
                name: "clone",
        ...
        !o && Ne(R, n.dragClass, !0),
        o
          ? ((eo = !0), (t._loopId = setInterval(t._emulateDragOver, 50)))
          : (re(document, "mouseup", t._onDrop),
            re(document, "touchend", t._onDrop),
            re(document, "touchcancel", t._onDrop),
            r &&
              ((r.effectAllowed = "move"),
              n.setData && n.setData.call(t, r, R)),
            se(document, "drop", t),
            W(R, "transform", "translateZ(0)")),
        (bt = !0),
        (t._dragStartId = Yt(t._dragStarted.bind(t, o, e))),
        se(document, "selectstart", t),
        (Ct = !0),
        Tt && W(document.body, "user-select", "none");
    },
    ...
    _onDragOver: function (e) {
      ...
      function a(U) {
        return (
          ...
          U &&
            (E ? h._hideClone() : h._showClone(b),
            b !== w &&
              (Ne(R, Ce ? Ce.options.ghostClass : h.options.ghostClass, !1),
              Ne(R, v.ghostClass, !0)),
            Ce !== b && b !== X.active
              ? (Ce = b)
              : b === X.active && Ce && (Ce = null),
            w === b && (b._ignoreWhileAnimating = t),
            b.animateAll(function () {
              s("dragOverAnimationComplete"), (b._ignoreWhileAnimating = null);
            }),
            b !== w && (w.animateAll(), (w._ignoreWhileAnimating = null))),
          ((t === R && !R.animated) || (t === o && !t.animated)) && (yt = null),
          !v.dragoverBubble &&
            !e.rootEl &&
            t !== document &&
            (R.parentNode[Me]._isOutsideThisEl(e.target), !U && ft(e)),
          !v.dragoverBubble && e.stopPropagation && e.stopPropagation(),
          (d = !0)
        );
      }
      function i() {
      ...
      if (
        ...
        h &&
          ...
          (E
            ? A || (m = ye !== fe)
            : Ce === this ||
              ((this.lastPutMode = Bt.checkPull(this, h, R, e)) &&
                l.checkPut(this, h, R, e))))
      ) {
        if (
          ((P = this._getDirection(e, t) === "vertical"),
          (r = ze(R)),
          s("dragOverValid"),
          X.eventCanceled)
        )
        ...
        if (m)
          return (
            ...
            s("revert"),
            X.eventCanceled ||
              (mt ? fe.insertBefore(R, mt) : fe.appendChild(R)),
            a(!0)
          );
        ...
        if (!c || (Nn(e, P, this) && !c.animated)) {
          ...
          if (
            (c && o === e.target && (t = c),
            t && (n = ze(t)),
            Zt(fe, o, R, r, t, n, e, !!t) !== !1)
          )
            return (
              f(),
              c && c.nextSibling
                ? o.insertBefore(R, c.nextSibling)
                : o.appendChild(R),
              (ye = o),
              i(),
              a(!0)
          ...
          var $ = 0,
            ...
            C = R.parentNode !== o,
            u = !_n(
              (R.animated && R.toRect) || r,
              (t.animated && t.toRect) || n,
              P
            ),
            y = P ? "top" : "left",
            _ = qo(t, "top", "top") || qo(R, "top", "top"),
            S = _ ? _.scrollTop : void 0;
          yt !== t && ((z = n[y]), (Mt = !1), (Ht = (!u && v.invertSwap) || C)),
            ($ = kn(
              e,
              t,
              n,
              P,
              u ? 1 : v.swapThreshold,
              v.invertedSwapThreshold == null
                ? v.swapThreshold
                : v.invertedSwapThreshold,
              Ht,
              yt === t
            ));
          var T;
          ...
          if (F !== !1)
            return (
              ...
              k && !L
                ? o.appendChild(R)
                : t.parentNode.insertBefore(R, k ? L : t),
              _ && Pr(_, 0, S - _.scrollTop),
              (ye = R.parentNode),
              z !== void 0 && !Ht && (Xt = Math.abs(z - ze(t)[y])),
              i(),
              a(!0)
            );
        }
        if (o.contains(R)) return a(!1);
      }
      return !1;
    },
    ...
    _offMoveEvents: function () {
      re(document, "mousemove", this._onTouchMove),
        ...
        re(document, "dragover", ft),
        re(document, "mousemove", ft),
        re(document, "touchmove", ft);
    },
    _offUpEvents: function () {
      var e = this.el.ownerDocument;
      re(e, "mouseup", this._onDrop),
        re(e, "touchend", this._onDrop),
        re(e, "pointerup", this._onDrop),
        re(e, "touchcancel", this._onDrop),
        re(document, "selectstart", this);
    },
    _onDrop: function (e) {
      var o = this.el,
        t = this.options;
      ...
      (bt = !1),
        ...
        clearTimeout(this._dragStartTimer),
        Eo(this.cloneId),
        Eo(this._dragStartId),
        this.nativeDraggable &&
          (re(document, "drop", this), re(o, "dragstart", this._onDragStart)),
        this._offMoveEvents(),
        this._offUpEvents(),
        Tt && W(document.body, "user-select", ""),
        W(R, "transform", ""),
        e &&
          (Ct &&
            (e.cancelable && e.preventDefault(),
          ...
          (fe === ye || (Ce && Ce.lastPutMode !== "clone")) &&
            he &&
            he.parentNode &&
            he.parentNode.removeChild(he),
          R &&
            (this.nativeDraggable && re(R, "dragend", this),
            bo(R),
            (R.style["will-change"] = ""),
            Ct &&
              !bt &&
              Ne(R, Ce ? Ce.options.ghostClass : this.options.ghostClass, !1),
            Ne(R, this.options.chosenClass, !1),
            Ie({
              sortable: this,
              name: "unchoose",
              toEl: ye,
    ...
    toArray: function () {
      for (
        ...
        (o = t[r]),
          Ue(o, m.draggable, this.el, !1) &&
            e.push(o.getAttribute(m.dataIdAttr) || On(o));
      return e;
    },
    /**
    ...
    destroy: function () {
      ...
      (e[Me] = null),
        ...
        this.nativeDraggable &&
          (re(e, "dragover", this), re(e, "dragenter", this)),
        ...
        this._onDrop(),
        this._disableDelayedDragEvents(),
        to.splice(to.indexOf(this.el), 1),
        (this.el = e = null);
    },
    _hideClone: function () {
      if (!it) {
        if ((De("hideClone", this), X.eventCanceled)) return;
        W(he, "display", "none"),
    ...
    _showClone: function (e) {
      ...
      if (it) {
        if ((De("showClone", this), X.eventCanceled)) return;
        R.parentNode == fe && !this.options.group.revertClone
          ? fe.insertBefore(he, R)
          : mt
          ? fe.insertBefore(he, mt)
          : fe.appendChild(he),
          this.options.group.revertClone && this.animate(R, he),
          W(he, "display", ""),
          (it = !1);
      }
    },
...
function Dn(e, o, t) {
  var r = ze(At(t.el, 0, t.options, !0)),
    n = _r(t.el, t.options, K),
    m = 10;
  return o
    ? e.clientX < n.left - m || (e.clientY < r.top && e.clientX < r.right)
    : e.clientY < n.top - m || (e.clientY < r.bottom && e.clientX < r.left);
}
function Nn(e, o, t) {
  var r = ze(No(t.el, t.options.draggable)),
    n = _r(t.el, t.options, K),
    m = 10;
  return o
    ? e.clientX > n.right + m || (e.clientY > r.bottom && e.clientX > r.left)
    : e.clientY > n.bottom + m || (e.clientX > r.right && e.clientY > r.top);
}
function kn(e, o, t, r, n, m, v, l) {
  var h = r ? e.clientY : e.clientX,
    E = r ? t.height : t.width,
    A = r ? t.top : t.left,
    w = r ? t.bottom : t.right,
    P = !1;
  if (!v) {
    if (l && Xt < E * n) {
      if (
        (!Mt &&
          (kt === 1 ? h > A + (E * m) / 2 : h < w - (E * m) / 2) &&
          (Mt = !0),
        Mt)
      )
        P = !0;
      else if (kt === 1 ? h < A + Xt : h > w - Xt) return -kt;
    } else if (h > A + (E * (1 - n)) / 2 && h < w - (E * (1 - n)) / 2)
      return Mn(o);
  }
  return (
    (P = P || v),
    P && (h < A + (E * m) / 2 || h > w - (E * m) / 2)
      ? h > A + E / 2
        ? 1
        : -1
      : 0
...
function On(e) {
  for (
    var o = e.tagName + e.className + e.src + e.href + e.textContent,
      t = o.length,
      r = 0;
    t--;
  ...
  return (
    (e.prototype = {
      ...
      _handleAutoScroll: function (o, t) {
        var r = this,
          n = (o.touches ? o.touches[0] : o).clientX,
          m = (o.touches ? o.touches[0] : o).clientY,
          v = document.elementFromPoint(n, m);
        if (
          ((ro = o),
          t || this.options.forceAutoScrollFallback || Ft || nt || Tt)
        ) {
...
var zo = Ar(function (e, o, t, r) {
    if (o.scroll) {
      var n = (e.touches ? e.touches[0] : e).clientX,
        m = (e.touches ? e.touches[0] : e).clientY,
        v = o.scrollSensitivity,
        l = o.scrollSpeed,
        h = Ye(),
        E = !1,
        A;
          ...
          ? (($ =
            ...
            (z =
              ...
              (y.overflowY === "auto" ||
                ...
                y.overflowY === "visible")))
          : (($ =
              c < C && (y.overflowX === "auto" || y.overflowX === "scroll")),
            (z =
              p < u && (y.overflowY === "auto" || y.overflowY === "scroll")));
        var T =
            $ &&
            (Math.abs(i - n) <= v && _ + c < C) - (Math.abs(a - n) <= v && !!_),
          M =
            z &&
            (Math.abs(f - m) <= v && S + p < u) - (Math.abs(s - m) <= v && !!S);
        if (!$e[w]) for (var L = 0; L <= w; L++) $e[L] || ($e[L] = {});
        ($e[w].vx != T || $e[w].vy != M || $e[w].el !== b) &&
          (($e[w].el = b),
          ($e[w].vx = T),
          ($e[w].vy = M),
          clearInterval($e[w].pid),
          (T != 0 || M != 0) &&
            ((E = !0),
            ($e[w].pid = setInterval(
              function () {
                r && this.layer === 0 && X.active._onTouchMove(ro);
                var k = $e[this.layer].vy ? $e[this.layer].vy * l : 0,
                  F = $e[this.layer].vx ? $e[this.layer].vx * l : 0;
                (typeof A == "function" &&
                  A.call(
                    X.dragged.parentNode[Me],
                    F,
                    k,
                    e,
                    ro,
  ...
  Nr = function (e) {
    var o = e.originalEvent,
      ...
      v = e.hideGhostForTarget,
      l = e.unhideGhostForTarget;
    if (o) {
      var h = t || n;
      v();
      var E =
          o.changedTouches && o.changedTouches.length ? o.changedTouches[0] : o,
        A = document.elementFromPoint(E.clientX, E.clientY);
      l(),
        h &&
          !h.el.contains(A) &&
          (m("spill"),
...
ko.prototype = {
  ...
  onSpill: function (e) {
    ...
    r ? this.sortable.el.insertBefore(o, r) : this.sortable.el.appendChild(o),
...
function Vn(...e) {
  ...
  function P(u) {
    ...
    const M = G((y = G(v)) == null ? void 0 : y[S]),
      L = A(M);
    rr(M, L), (T[nr] = L);
  }
  function b(u) {
  ...
  function i(u) {
    const y = G(m);
    return (
      u || (u = nn(y) ? an(y, r == null ? void 0 : r.$el) : y),
      u && !dn(u) && (u = u.$el),
      u || void 0,
      u
    );
  ...
  function c() {
    var u;
    const y = (u = G(l)) != null ? u : {},
      { immediate: _, clone: S } = y,
      T = yr(y, ["immediate", "clone"]);
    return (
      Xo(T, (M, L) => {
        cn(M) &&
          (T[M] = (k, ...F) => {
  ...
  const $ = {
    ...
    C = () => ($ == null ? void 0 : $.option("disabled", !1));
  return (
    Bn(() => {
      E && p();
    }),
    xn($.destroy),
    $t({ start: p, pause: z, resume: C }, $)
  );
}
const So = [
    "update",
      ...
      const m = So.reduce((A, w) => {
        ...
        v = de(() => {
          const A = fr(e),
            { modelValue: w } = A,
            P = yr(A, ["modelValue"]),
            b = Object.entries(P).reduce((d, [s, f]) => {
              const a = G(f);
      ...
      return (
        ...
        () => {
          ...
          return Kr(
            e.tag || "div",
            { ref: h },
            (A = o == null ? void 0 : o.default) == null ? void 0 : A.call(o, E)
          );
        }
      );
    },
  }),
  Un = { class: "zero-code-data-display" },
  Wn = { class: "zero-code-data-tabs" },
  Xn = ["onClick"],
  Yn = { class: "zero-code-data-content" },
  Kn = {
    key: 0,
  ...
  qn = { class: "zero-code-add-part-button-container" },
  Gn = { class: "zero-code-component-header" },
  Qn = { class: "zero-code-header-actions" },
  ea = ["onClick"],
  ta = ["onClick"],
  oa = ["innerHTML"],
  ra = { class: "zero-code-add-part-button-container" },
  na = ["onClick"],
  aa = {
    key: 1,
    class: "zero-code-no-data",
  },
  sa = { class: "zero-code-empty-state" },
  ia = { class: "zero-code-add-part-button-container" },
  la = {
    key: 1,
    class: "zero-code-data-section",
  },
  da = { class: "zero-code-data-display-section" },
  ca = { class: "zero-code-parts-sub-content" },
  ua = { class: "zero-code-parts-sub-section" },
  pa = { class: "zero-code-data-display-pre" },
  fa = /* @__PURE__ */ _e({
    __name: "DataDisplay",
    props: {
...
${s}}`;
                                      ...
                                      [
                                        ...
                                        g(
                                          "div",
                                          {
                                            ...
                                            innerHTML:
                                              w.renderComponentWithNested(b, d),
                                          },
                                          null,
                                          8,
                                          oa
  ...
  ma = { class: "zero-code-modal-header" },
  ga = { class: "zero-code-data-tabs" },
  ha = ["onClick"],
  va = { class: "zero-code-modal-body" },
  ya = {
    key: 0,
  ...
  $a = { class: "zero-code-part-section-title" },
  wa = { class: "zero-code-modules-grid" },
  za = ["onClick"],
  Aa = { class: "zero-code-module-title" },
  Pa = ["innerHTML"],
  Ea = {
    key: 1,
  ...
  Sa = { class: "zero-code-part-section-title" },
  Ia = { class: "zero-code-modules-grid" },
  Ta = ["onClick"],
  Da = { class: "zero-code-module-title" },
  Na = ["innerHTML"],
  ka = {
    key: 1,
    class: "zero-code-empty-state",
        ...
        A = (w) => {
          ...
          try {
            ...
            return (
              ...
              (P = P.replace(
                /\(\$([^:]+):([^)]+)\)/g,
                (b, d, s) => s.split("|").filter((a) => a.trim())[0] || ""
              )),
              (P = P.replace(
                /\(\$([^:?]+)\?:([^)]*)\)/g,
                (b, d, s) => s || ""
              )),
              (P = P.replace(/z-for-wrapper="[^"]*"/g, "")),
              (P = P.replace(/z-for="[^"]*"/g, "")),
              (P = P.replace(/z-slot="[^"]*"/g, "")),
              (P = P.replace(
                /\$(\w+)/g,
                (b, d) =>
                  ({
  ...
  Ma = { class: "zero-code-array-field" },
  Oa = { class: "zero-code-array-header" },
  Fa = {
    key: 0,
    class: "zero-code-empty-array-message",
  },
  Ra = { class: "zero-code-empty-message-content" },
  La = { class: "zero-code-empty-text" },
  xa = { class: "zero-code-button-text" },
  Ba = ["onDragstart", "onDrop"],
  Ha = { class: "zero-code-array-item-header" },
  Va = { class: "zero-code-array-item-controls" },
  Za = ["onClick"],
  ja = { class: "zero-code-array-item-fields" },
  Ua = ["for"],
  Wa = {
    key: 0,
    class: "zero-code-radio-group",
  },
  Xa = ["id", "value", "name", "checked", "onChange"],
  Ya = ["for"],
  Ka = {
    key: 1,
    class: "zero-code-checkbox-group",
  },
  Ja = ["id", "checked", "onChange"],
  qa = ["for"],
  Ga = ["id", "value", "onInput"],
  Qa = ["value"],
  es = ["id", "value", "onChange"],
  ts = ["value", "selected"],
  os = ["id", "value", "onInput"],
  rs = ["id", "value", "type", "onInput"],
  ns = {
    key: 0,
    class: "zero-code-nested-array-field",
  },
  as = { class: "zero-code-nested-array-label" },
  ss = { class: "zero-code-nested-array-info" },
  is = { class: "zero-code-array-count" },
  ls = ["onClick"],
  ds = /* @__PURE__ */ _e({
      ...
      const h = (b, d) => {
          (l = d),
            b.dataTransfer &&
              ...
              b.dataTransfer.setData("text/plain", d.toString()));
          const s = b.target;
          s.style.opacity = "0.5";
        },
        E = (b) => {
        ...
        P = (b, d) =>
          !Array.isArray(d) ||
          b === "id" ||
          ["nested_parts", "content"].includes(b)
            ? !1
...
var ue = /* @__PURE__ */ ((e) => (
  ...
  (e.IMAGE_LOAD_FAILED = "IMAGE_LOAD_FAILED"),
  (e.UNKNOWN = "UNKNOWN"),
  (e.NETWORK_ERROR = "NETWORK"),
  (e.VALIDATION_ERROR = "VALIDATION"),
  (e.PERMISSION_ERROR = "PERMISSION"),
  (e.COMPONENT_ERROR = "COMPONENT"),
  (e.TEMPLATE_PARSE_ERROR = "TEMPLATE"),
  (e.UNKNOWN_ERROR = "UNKNOWN"),
  e
))(ue || {});
class cs {
  constructor() {
  ...
  componentError(o, t, r) {
    return this.handleError("COMPONENT", o, r, t, "component_operation");
  }
  /**
   * テンプレート関連エラー
   */
   ...
   */
  getErrorStats() {
    const o = Object.values(ue).reduce((t, r) => ((t[r] = 0), t), {});
    return (
      this.errorHistory.forEach((t) => {
        o[t.type]++;
      }),
      o
    );
...
function no(e) {
  const o = (u, y) => {
      ...
      for (let S = 1; S < y.length; S++) {
        if (
          !_.nested_parts ||
          !Array.isArray(_.nested_parts) ||
          y[S] >= _.nested_parts.length
        )
          return null;
    ...
    r = (u) => u.split("-").map(Number),
    n = (u) => u.join("-"),
    m = (u, y, _ = []) => {
      if (
        (I.debug(
          `findComponentRecursively: 検索開始 - componentId=${y}, depth=${_.length}`
        ),
        !u || !Array.isArray(u))
      )
        return (
      ...
      for (let S = 0; S < u.length; S++) {
        ...
        if (
          (I.debug(
            `findComponentRecursively: [${S}] チェック中 - id=${T.id}, type=${T.type}`
          ),
          T.id === y)
        )
          return (
            I.success(
              `findComponentRecursively: 発見！ - ${y} at path=${M.join("-")}`
            ),
            T
          );
        if (T.nested_parts && Array.isArray(T.nested_parts)) {
          I.debug(
            `findComponentRecursively: nested_parts検索 - ${T.id} (${T.nested_parts.length}個)`
          );
        ...
        for (const k of L) {
          ...
          if (Array.isArray(F) && k !== "nested_parts") {
            I.debug(
              `findComponentRecursively: z-for配列検索 - ${T.id}.${k} (${F.length}個)`
            );
            for (let U = 0; U < F.length; U++) {
              ...
              if (x && typeof x == "object" && x.id) {
                if (
                  (I.debug(
                    `findComponentRecursively: z-for配列アイテム - ${x.id} in ${T.id}.${k}[${U}]`
                  ),
                  x.id === y)
                )
                  return (
                    I.success(
                      `findComponentRecursively: z-for配列アイテムで発見！ - ${y}`
                    ),
                    x
                  );
                if (x.nested_parts && Array.isArray(x.nested_parts)) {
                  I.debug(
                    `findComponentRecursively: z-for配列アイテムのネストパーツ検索 - ${x.id}.nested_parts (${x.nested_parts.length}個)`
                  );
                  const q = m(x.nested_parts, y, [...M, U]);
                  if (q)
                    return (
                      I.success(
                        `findComponentRecursively: z-for配列内のネストパーツで発見！ - ${y}`
                      ),
                      q
                    );
                }
    ...
    v = (u, y) =>
      Je(
        () => {
          if (!Array.isArray(e)) throw new Error("Parts配列が無効です");
          if (!u || !y)
            throw new Error("Type または ModuleName が指定されていません");
          const _ = e.find((T) => T.type === u);
          if (!_) throw new Error(`パーツタイプ "${u}" が見つかりません`);
    ...
    h = (u, y) => {
      ...
      const _ = new RegExp(`<div[^>]*z-for="${y}"[^>]*>`),
        S = u.match(_);
      if (!S)
        return (
          I.warn(`z-for="${y}" 開始タグが見つかりません`),
          I.debug("親テンプレート内容:", u.substring(0, 500)),
          ""
        );
      ...
      if (M !== 0)
        return (
          I.warn(
            `z-for="${y}" の対応する終了タグが見つかりません（深度: ${M}）`
          ),
          ""
        );
      const F = u.substring(T, L).trim();
      return (
        I.debug(`z-for内テンプレート抽出成功: ${y}`, {
    ...
    A = (u) => {
      ...
      if (l.has(y))
        return (
          I.warn(`getFieldInfo: 無限ループを検出、処理をスキップ: ${y}`), []
        );
      l.add(y);
      try {
        ...
        if (
          ...
          I.debug(`getFieldInfo: _isZForItem=${u._isZForItem}`),
          u._isZForItem)
        ) {
          const k = u._arrayName;
          if (
            (I.debug(`getFieldInfo: z-for配列要素を検出, arrayName=${k}`),
            I.debug("getFieldInfo: componentプロパティ:", Object.keys(u)),
            k)
          ) {
            ...
            F
              ? ((_ = F),
                I.debug("getFieldInfo: z-for内テンプレート抽出完了:", _))
              : I.warn(
                  `getFieldInfo: z-for内テンプレートの抽出に失敗: arrayName=${k}`
                );
          }
        } else I.debug("getFieldInfo: 通常のコンポーネント処理");
        const S = [],
          T = _.match(/\(\$([^:]+):(.*?)\)/g) || [],
          M = [];
        if (_.includes("z-for=")) {
          ...
          u._isZForItem
            ? (L = T.filter((k) => {
                ...
                if (F) {
                  ...
                  return (
                    x &&
                      I.debug(`z-for配列アイテム編集: フィールド ${U} を表示`),
                    x
                  );
                }
                return !1;
            ...
            : (L = T.filter((k) => {
                ...
                if (F) {
                  ...
                  return (
                    x &&
                      I.debug(`フィールド ${U} を z-for内フィールドとして除外`),
                    !x
                  );
                }
                return !0;
            ...
            if (F) {
              ...
              if (x.includes("|")) {
                let Z = x.split("|"),
                  te = !1;
                if (
                  ((x.includes("||") || x.startsWith("|") || x.endsWith("|")) &&
                    (te = !0),
                  (Z = Z.filter((le) => le.trim() !== "")),
                  te && Z.unshift("指定なし"),
                  q)
                ) {
                  const le = Z.length > 0 ? [Z[0]] : [],
                    Re = {
                      type: "checkbox",
                      paramName: V,
                      propKey: V,
  ...
  return {
    ...
    shouldShowArrayField: (u, y, _) => {
      ...
      if (l.has(S))
        return (
          I.warn(
            `shouldShowArrayField: 無限ループを検出、処理をスキップ: ${S}`
          ),
          !1
        );
      l.add(S);
      try {
        ...
        } else I.debug("shouldShowArrayField: テンプレート取得失敗");
        return (
          Array.isArray(y) ||
            I.debug(
        ...
        return (
          I.error(`shouldShowArrayField: エラーが発生しました: ${S}`, T), !1
        );
      } finally {
        l.delete(S);
      }
    },
    shouldShowArrayItemField: (u, y, _, S, T) =>
      u === "id" ||
      Array.isArray(y) ||
      (typeof y == "object" && y !== null) ||
      y === "" ||
    ...
    createNewComponent: (u, y) =>
      Je(
        () => {
          ...
          return (
            F
              ? (I.debug("createNewComponent: z-for記法発見:", F),
                F.forEach((U) => {
                  ...
                  if (x) {
                    ...
                    S[q]
                      ? I.debug(
                          `createNewComponent: z-for配列 ${q} は既に初期化済み`
                        )
                      : (I.debug(
                          `createNewComponent: z-for配列 ${q} を空配列で初期化`
                        ),
                        (S[q] = []));
                  }
                }))
              : I.debug("createNewComponent: z-for記法が見つかりませんでした"),
            I.debug("createNewComponent完了: newComponent=", S),
            S
          );
        },
        qe,
...
const ps = { class: "zero-code-content-sidebar" },
  fs = {
    key: 0,
    class: "zero-code-editable-component",
  },
  ms = { class: "zero-code-component-info" },
  gs = { class: "zero-code-component-type" },
  hs = { class: "zero-code-component-module" },
  vs = { class: "zero-code-component-id" },
  ys = { class: "zero-code-fields" },
  bs = { class: "zero-code-field-label" },
  $s = {
    key: 0,
  ...
  As = ["id", "value", "name", "checked", "onChange"],
  Ps = ["for"],
  Es = {
    key: 2,
    class: "zero-code-checkbox-group",
  },
  _s = ["id", "checked", "onChange"],
  Cs = ["for"],
  Ss = {
    key: 3,
  ...
  Os = ["for"],
  Fs = ["id", "value", "type", "readonly", "onInput"],
  Rs = /* @__PURE__ */ _e({
    __name: "EditorPanel",
    props: {
      ...
      const l = (s, f, a, i) => {
        ...
        w = (s, f, a) => {
          ...
          const c = [...i],
            [p] = c.splice(f, 1);
          c.splice(a, 0, p),
            (t.selectedComponent[s] = c),
            r("reorder:array-item", s, f, a);
        },
        P = (s) => {
          if (!t.selectedComponent) return {};
          const f = {};
          if (t.partsData) {
            const c = no(t.partsData).getArrayItemFieldInfo(
              t.selectedComponent,
              s
            );
            if (
              ...
              Object.keys(i).forEach((c) => {
                c !== "id" &&
                  ...
                  (f[c] = {
                    ...
                    type:
                      c.includes("desc") || c.includes("content")
                        ? "textarea"
                        : "text",
                  }));
              });
        ...
        d = (s) => {
          let f = s;
          return (
            s.endsWith("s") && (f = s.slice(0, -1)),
            f.replace(/_/g, " ").replace(/\b\w/g, (a) => a.toUpperCase())
          );
        };
      return (s, f) =>
        s.showEditor && s.selectedComponent
          ? (D(),
            N(
              "div",
              {
                          ...
                          N("div", fs, [
                            g("div", ms, [
                              ...
                              g(
                                "span",
                                hs,
                                H(s.selectedComponent.module_name),
                                1
                              ),
                              g(
                                "span",
                                vs,
                                "ID: " + H(s.selectedComponent.id),
                                1
                              ),
                            ]),
                            g("div", ys, [
                              ...
                              N(
                                ...
                                null,
                                ae(
                                  s.getFieldInfo(s.selectedComponent),
                                  (a) => (
                                    D(),
                                    N(
                                      "div",
  ...
  Ls = { class: "zero-code-tab-content" },
  xs = /* @__PURE__ */ _e({
        ...
        N("div", Ls, [
          ht(
            fa,
            {
              ...
              parts:
                t.localParts && t.localParts.length > 0
                  ? t.localParts
                  : t.parts || [],
                ...
                ar,
                {
                  ...
                  parts:
                    t.localParts && t.localParts.length > 0
                      ...
                      : t.parts || [],
                  onClose:
                    r[5] || (r[5] = (n) => t.$emit("close-part-selector")),
                  onSelectPart:
                    r[6] || (r[6] = (n, m) => t.$emit("select-part", n, m)),
                },
                null,
                8,
                ["parts"]
            ...
            ? (D(),
              Be(
                ar,
                {
                  ...
                  onClose:
                    r[7] ||
                    (r[7] = (n) => t.$emit("close-nested-part-selector")),
                  onSelectPart:
                    r[8] ||
                    (r[8] = (n, m) => t.$emit("select-nested-part", n, m)),
                },
                null,
                8,
                ["parts"]
          ...
          Be(
            Rs,
            {
              ...
              "onUpdate:value":
                r[10] ||
                (r[10] = (n, m) => t.$emit("update-editor-value", n, m)),
              "onAdd:arrayItem":
                r[11] || (r[11] = (n) => t.$emit("add-array-item", n)),
              "onRemove:arrayItem":
                r[12] || (r[12] = (n, m) => t.$emit("remove-array-item", n, m)),
              "onUpdate:arrayItem":
                r[13] || (r[13] = (n) => t.$emit("update-array-item", n)),
              "onUpdate:checkbox":
                r[14] || (r[14] = (n) => t.$emit("update-checkbox", n)),
            },
            null,
            8,
            [
  ...
  Bs = { class: "zero-code-data-display" },
  Hs = { class: "zero-code-component-header" },
  Vs = { class: "zero-code-data-tabs" },
  Zs = { class: "zero-code-form-group" },
  js = { class: "zero-code-form-group" },
  Us = ["value"],
  Ws = { class: "zero-code-data-content" },
  Xs = {
    key: 0,
    class: "zero-code-rendered-content",
  },
  Ys = { class: "zero-code-component-header" },
  Ks = { class: "zero-code-component-id" },
  Js = { class: "zero-code-rendered-component" },
  qs = { class: "zero-code-component-header" },
  Gs = { class: "zero-code-header-actions" },
  Qs = ["onClick"],
  ei = ["onClick"],
  ti = ["innerHTML"],
  oi = {
  ...
  ir = /* @__PURE__ */ _e({
    ...
    setup(e, { emit: o }) {
      const t = e,
        ...
        n = ne(""),
        m = ne(""),
        v = de(() => Array.from(new Set(t.parts.map((A) => A.type)))),
        l = de(() => {
          let A = [...t.parts];
  ...
  ri = { class: "zero-code-modal-header" },
  ni = { class: "zero-code-modal-title" },
  ai = { class: "zero-code-modal-subtitle" },
  si = { class: "zero-code-category-badge" },
  ii = { class: "zero-code-modal-body" },
  li = { class: "zero-code-form-layout" },
  di = { class: "zero-code-form-section" },
  ci = {
    key: 0,
    class: "zero-code-form-group",
  },
  ui = { class: "zero-code-type-input-group" },
  pi = ["value"],
  fi = {
    key: 1,
    class: "zero-code-form-group",
  },
  mi = { class: "zero-code-form-group" },
  gi = { class: "zero-code-body-editor-container" },
  hi = { class: "zero-code-preview-section" },
  vi = { class: "zero-code-preview-container" },
  yi = ["innerHTML"],
  bi = { class: "zero-code-modal-footer" },
  $i = { class: "zero-code-modal-actions" },
  wi = ["disabled"],
  zi = /* @__PURE__ */ _e({
    ...
    setup(e, { emit: o }) {
      const t = e,
        ...
        v = de(
          () =>
            (t.isEditing ||
              (m.value.type.trim() !== "" && m.value.title.trim() !== "")) &&
            m.value.body.trim() !== ""
        ),
        l = () => {},
        h = () => {
                        ...
                        : (D(),
                          N("div", ci, [
                            ...
                            g("div", ui, [
                              ...
                              !m.value.type ||
                              !E.existingTypes.includes(m.value.type)
                                ? Oe(
                                    (D(),
                                    N(
                                      "input",
  ...
  Ai = { class: "zero-code-tab-content" },
  Pi = { class: "zero-code-data-tabs" },
  Ei = ["onClick"],
  _i = { class: "zero-code-parts-content" },
  Ci = {
    key: 0,
    class: "zero-code-parts-section",
  },
  Si = { class: "zero-code-section-header" },
  Ii = {
    key: 1,
    class: "zero-code-parts-section",
  },
  Ti = { class: "zero-code-section-header" },
  Di = {
    key: 2,
    class: "zero-code-parts-section",
  },
  Ni = { class: "zero-code-data-display-section" },
  ki = { class: "zero-code-parts-sub-tabs" },
  Mi = { class: "zero-code-parts-sub-content" },
  Oi = {
    key: 0,
    class: "zero-code-parts-sub-section",
  },
  Fi = { key: 0 },
  Ri = { class: "zero-code-data-display-pre" },
  Li = { key: 1 },
  xi = {
    key: 1,
    class: "zero-code-parts-sub-section",
  ...
  Bi = { key: 0 },
  Hi = { class: "zero-code-data-display-pre" },
  Vi = { key: 1 },
  Zi = /* @__PURE__ */ _e({
    ...
    setup(e, { emit: o }) {
      const t = e,
        ...
        E = de(() =>
          t.localCommonParts && t.localCommonParts.length > 0
            ? t.localCommonParts
            : t.localParts
                .map((a) => ({
                  ...a,
        ...
        A = de(() =>
          t.localIndividualParts && t.localIndividualParts.length > 0
            ? t.localIndividualParts
            : t.localParts
                .map((a) => ({
                  ...a,
                  ...
                  g("div", Ni, [
                    g("div", ki, [
                      ...
                      g(
                        "button",
                        {
                          class: Fe([
                            "zero-code-parts-sub-tab-button",
                            { active: v.value === "individual" },
                          ]),
                          onClick:
                            i[5] || (i[5] = (c) => (v.value = "individual")),
                        },
                        " 個別Partsデータ ",
                        2
                      ),
                    ...
                    g("div", Mi, [
                      v.value === "common"
                        ? (D(),
                          N("div", Oi, [
                            a.localCommonParts && a.localCommonParts.length > 0
                              ? (D(),
                                N("div", Fi, [
                      ...
                      v.value === "individual"
                        ? (D(),
                          N("div", xi, [
                            a.localIndividualParts &&
                            a.localIndividualParts.length > 0
                              ? (D(),
                                N("div", Bi, [
...
function Oo(e, o) {
  e.querySelectorAll("[z-if]").forEach((r) => {
    ...
    n &&
      (o[n]
        ? (r.removeAttribute("z-if"), I.debug(`z-if要素を表示: ${n}`))
        : (r.remove(), I.debug(`z-if要素を非表示: ${n}`)));
  });
}
function Ui(e, o) {
  const t = e.querySelectorAll("[z-for-wrapper]");
  I.debug(`z-for-wrapper要素検索結果: ${t.length}個発見`),
    t.forEach((r) => {
      ...
      if (n) {
        ...
        I.debug(`z-for-wrapper処理: ${n}`, {
          ...
          !Array.isArray(m) || m.length === 0
            ? (I.debug(
                `z-for-wrapper空配列: ${n} - wrapper要素は保持、属性のみ除去`
              ),
              r.removeAttribute("z-for-wrapper"))
            : (I.success(`z-for-wrapper配列あり: ${n} - 属性除去`),
              r.removeAttribute("z-for-wrapper"));
      }
    });
}
function Wi(e, o) {
  return `
    <div class="zero-code-add-array-item-button-container">
      <button class="zero-code-add-array-item-button" onclick="window.addArrayItem('${ie(
        e
      )}', '${ie(o)}')">
...
function Or(e, o, t, r, n) {
  ...
  I.debug("=== processZForElements(DOM版)開始 ==="),
    I.debug(`z-for要素検索結果: ${m.length}個発見`),
    I.debug("コンポーネントデータ:", o),
    m.forEach((v) => {
      ...
      if (l) {
        ...
        if (
          ...
          const E = n(o.type, o.module_name),
            A = new RegExp(`<div[^>]*z-for="${l}"[^>]*>`),
            w = E.match(A),
            P = w ? E.indexOf(w[0]) : -1;
          if (P !== -1) {
            let b = 0,
            ...
            for (let a = P; a < E.length; a++)
              if (E.substring(a, a + 4) === "<div") b++;
              else if (E.substring(a, a + 6) === "</div>" && (b--, b === 0)) {
                d = a + 6;
                break;
              }
            const s = E.substring(P, d),
              f = [s];
            if (f && f[0]) {
              let a = "";
              ...
              if (z) {
                ...
                I.debug(`z-for処理開始: ${l}`, {
                  ...
                  <div class="zero-code-z-for-controls" data-component-id="${
                    o.id
                  }" data-array-name="${l}" data-index="${S}">
                    <div class="zero-code-z-for-controls-inner">
                      <button class="zero-code-z-for-btn zero-code-z-for-add-btn" onclick="window.addZForArrayItem('${ie(
                        o.id
                      )}', '${ie(l)}', ${S})" title="上に追加">
                      ...
                      <button class="zero-code-z-for-btn zero-code-z-for-edit-btn" onclick="window.editZForArrayItem('${ie(
                        o.id
                      )}', '${ie(l)}', ${S})" title="編集">
                        <span class="zero-code-control-icon">✎</span>
                      </button>
                      <button class="zero-code-z-for-btn zero-code-z-for-delete-btn" onclick="window.removeZForArrayItem('${ie(
                        o.id
                      )}', '${ie(l)}', ${S})" title="削除">
                        <span class="zero-code-control-icon">✕</span>
                      </button>
                ...
                `;
                    if (
                      (Ot &&
                        (I.debug("テキスト置換前:", { itemHtml: T, item: _ }),
                        (T = Ot(T, _, o, E, l)),
                        I.debug("テキスト置換後:", { itemHtml: T })),
                      tt && (T = tt(T, _)),
                      T.includes("z-if") ||
                        T.includes("z-slot") ||
                        T.includes("z-for"))
                      ...
                      Oo(V, te),
                        V.querySelectorAll("[z-slot]").forEach((Ve) => {
                          ...
                          if (Ae && te[Ae]) {
                            ...
                            <div class="zero-code-add-nested-part-button-container">
                              <button class="zero-code-add-nested-part-button" onclick="window.openNestedPartSelector('${ie(
                                xt
                              )}', ${dt})">
                                <span class="zero-code-plus-icon">＋</span>
                            ...
                            <div class="zero-code-nested-component zero-code-nested-depth-${lo} zero-code-z-for-nested-part" 
                              ...
                              <div class="zero-code-component-header zero-code-nested-header">
                                ...
                                <div class="zero-code-header-actions">
                                  <button class="zero-code-edit-button" onclick="window.openNestedEditor('${ie(
                                    Le
                                  )}')">編集</button>
                                  <button class="zero-code-delete-button" onclick="window.deleteNestedPart('${ie(
                                    Le
                                  )}')">削除</button>
                                </div>
                              </div>
                      ...
                      `),
                        ...
                        V.querySelectorAll("[z-for]").length > 0 &&
                          Or(V, te, t + 1, r, n),
                        (T = V.body.innerHTML.replace(/^<div>|<\/div>$/g, ""));
                    }
                    let L = c;
                    L.includes("($") && tt && (L = tt(L, _));
                    let k = "",
                      F = L;
                    if (L) {
                      ...
                      V &&
                        ((k = V[1]),
                        (F = L.replace(/\s*class="[^"]*"\s*/, "").trim()));
                    }
                    let x = `class="${
                      k
                        ? `zero-code-z-for-item-wrapper ${k}`
              ...
              `;
                ...
                if (y) {
                  ...
                  for (; _.firstChild; ) S.appendChild(_.firstChild);
                  y.replaceChild(S, v);
                } else v.outerHTML = a;
              }
            }
...
function Xi(e, o, t) {
  ...
  for (; (m = n.exec(e)) !== null; ) {
    const [v, l, h, E] = m,
      A = o[h];
    if (
      (I.debug(`=== processZForWithRegex(正規表現版)処理: ${h}`, {
        arrayData: A,
      ...
      A.forEach((b, d) => {
        ...
        if (
          ...
          Ot && (s = Ot(s, b, o, e, h)),
          tt && (s = tt(s, b)),
          s.includes("z-if") || s.includes("z-slot") || s.includes("z-for"))
        ) {
          ...
          Oo(C, y),
            C.querySelectorAll("[z-slot]").forEach((S) => {
        ...
        const c = a
            ? `zero-code-z-for-item-wrapper ${a}`
            : "zero-code-z-for-item-wrapper",
          p = `
          <div class="zero-code-z-for-controls" data-component-id="${
            o.id
          }" data-array-name="${h}" data-index="${d}">
            <div class="zero-code-z-for-controls-inner">
              <button class="zero-code-z-for-btn zero-code-z-for-add-btn" onclick="window.addZForArrayItem('${ie(
                o.id
              )}', '${ie(h)}', ${d})" title="上に追加">
      ...
      I.debug(`正規表現z-for空配列: ${h}に追加ボタンを設置`),
        (r = r.replace(v, Wi(o.id, h)));
  }
  return r;
}
function Yi(e, o, t, r, n) {
  const m = e.querySelectorAll("[z-slot]");
  I.debug(`z-slot要素発見: ${m.length}個`),
    m.forEach((v) => {
      ...
      if ((I.debug(`z-slot処理: ${l}`), l)) {
        ...
        if ((I.debug(`ネストパーツ数: ${E.length}個`), E.length === 0)) {
          const A = we
            ? `${we.parentId}.${we.arrayName}[${we.arrayIndex}].${we.slotName}`
            : o.id;
          (v.innerHTML = `
          <div class="zero-code-add-nested-part-button-container">
        ...
        `),
            (v.innerHTML = A),
            I.debug(
              `ネストパーツを編集UI付きで表示（重複防止版）: ${E.length}個`
            );
        }
...
function Gi(e) {
  return (
    Je(
      () => {
        const o = qi(e),
          r = new DOMParser().parseFromString(o.html, "text/html");
        return (
          I.debug("安全DOMパース完了", {
...
function ol(e, o, t) {
  ...
  const [, n, m] = r,
    ...
    l = cr(v ? String(v) : m);
  return rl(t, n)
    ? `<div class="tiptap-content" data-component-id="${o.id}" data-param-name="${n}">${l}</div>`
    : l;
}
function rl(e, o) {
  const t = o.replace(/[.*+?^${}()|[\]\\]/g, "\\$&"),
  ...
  return (
    Je(
      () => {
        ...
        return (
          gt.set(e, o.cloneNode(!0)),
          I.debug("DOMParser: 新規パース＆キャッシュ保存"),
          o
        );
      },
      qe,
...
function cl(e, o) {
  return e.replace(
    /<([^>]*z-if="([^"]*)"[^>]*)>([\\s\\S]*?)<\/[^>]*>/g,
    (t, r, n, m) => {
      if (!o[n]) return I.debug(`z-if要素を非表示: ${n}`), "";
    ...
    m.forEach((v) => {
      ...
      if (l) {
        ...
        if (E.length === 0)
          v.innerHTML = `
          <div class="zero-code-add-nested-part-button-container">
            <button class="zero-code-add-nested-part-button" onclick="window.openNestedPartSelector('${sl(
              o.id
            )}', 0)">
              <span class="zero-code-plus-icon">＋</span>
              <span class="zero-code-button-text">ネストパーツを追加</span>
...
function Fr() {
  ...
  const t = (a, i) => {
    ...
    n = (a, i, c, p, $) =>
      a.replace(/\{\$([^:]+):(.*?)\}/g, (z, C, u) => {
        const y = String(i[C] || u),
          _ = pr(y);
        if (t(p, C)) {
          const M = c[$].indexOf(i),
            L = `${c.id}_${$}_${M}_${C}`;
          return C === "content"
            ? `<div class="zero-code-rich-editable-text array-item-text block-editable" data-component-id="${L}" data-param="${C}" data-array-name="${$}" data-item-index="${M}" onclick="event.stopPropagation(); if(window.getSelection && window.getSelection().toString().length > 0) return; if(window.startRichTextEdit) window.startRichTextEdit('${L}', '${C}', this.innerHTML, this);">${_}</div>`
    ...
    h = (a, i, c, p, $) =>
      a.replace(/@slot\(\$([^)]+)\)@/g, (z, C) => {
        const u = i[C],
          y = Array.isArray(u) ? u : [];
        return c(y, [p], (_) => _.join("-"), $);
      }),
    E = (a, i, c, p) => {
    ...
    P = (a, i = [], c, p) => {
      if (!a || a.length === 0)
        return `
        <div class="zero-code-add-nested-part-button-container">
          <button class="zero-code-add-nested-part-button" onclick="window.openNestedPartSelector('${Ao(
            c(i)
          )}', 0)">
            <span class="zero-code-plus-icon">＋</span>
      ...
      Je(
        () => {
          I.debug("processZDirectives開始", {
            ...
            o || (ji(n, m), (o = !0));
          const { doc: z, preservation: C } = Gi(a),
            u = (M, L, k) => w(M, L, k);
          Oo(z, i), Ui(z, i), Or(z, i, $, u, c);
          const y = C.html.match(/z-for="[^"]*"/g),
            _ = z.querySelectorAll("[z-for]");
          if (
            (I.debug(
            ...
            if (M !== C.html)
              return (
                I.debug("正規表現処理で変更あり - Vue.js復元して終了"), dr(M, C)
              );
          }
          Yi(z, i, $, u, c);
          const S = z.body.innerHTML,
            T = dr(S, C);
          return (
            I.success(
...
const ml = { class: "zero-code-page-preview" },
  gl = { class: "zero-code-data-tabs" },
  hl = { class: "zero-code-page-preview-content" },
  vl = ["innerHTML"],
  yl = {
    key: 1,
    class: "zero-code-html-source",
  },
  bl = { class: "zero-code-html-source-pre" },
  $l = /* @__PURE__ */ _e({
    __name: "PagePreview",
    props: {
      pageData: { type: Array },
    ...
    setup(e) {
      ...
      const t = ne("rendered"),
        r = (P) => {
          if (!P) return "";
          try {
            const s = new globalThis.DOMParser().parseFromString(
              `<root>${P}</root>`,
              "text/html"
            ).body.firstChild;
            if (!s) return P;
...
`
              ...
              .map((d, s, f) => {
                ...
                return (
                  a.startsWith("</") && i--, "  ".repeat(Math.max(0, i)) + a
                );
              }).join(`
`);
          }
        ...
        m = () => {
          ...
          return (
            o.pageData.forEach((b, d) => {
              const s = v(b);
              !s || s.trim() === ""
                ? (P += `<div class="zero-code-error-component">テンプレートが見つかりません: ${b.type}/${b.module_name}</div>`)
                : (P += s);
            }),
            (P += "</div>"),
            P
        ...
        l = (P, b) => {
          ...
          return (
            s.querySelectorAll("[z-if]").forEach((p) => {
            ...
            s.querySelectorAll("[z-for-wrapper]").forEach((p) => {
              ...
              if ($) {
                ...
                !Array.isArray(z) || z.length === 0
                  ? p.remove()
                  : p.removeAttribute("z-for-wrapper");
              }
            }),
            s.querySelectorAll("[z-for]").forEach((p) => {
              ...
              if ($) {
                ...
                if (Array.isArray(z) && z.length > 0) {
                  const C = n(b.type, b.module_name),
                    u = h(C, $);
                  if (u) {
                    const y = z
                      .map((_) => {
        ...
        h = (P, b) => {
          const d = new RegExp(`<div[^>]*z-for="${b}"[^>]*>`),
            s = P.match(d);
          if (!s) return "";
          ...
          for (let u = f; u < P.length; u++)
            if (P.substring(u, u + 4) === "<div") a++;
            else if (P.substring(u, u + 6) === "</div>" && (a--, a === 0)) {
              i = u + 6;
              break;
            }
          if (a !== 0) return "";
          const c = P.substring(f, i),
            p = s[0].replace(/\s*z-for="[^"]*"\s*/, " ").replace(/\s+>/, ">"),
            $ = c.indexOf(">") + 1,
            z = c.lastIndexOf("</div>"),
            C = c.substring($, z);
          return p + C + "</div>";
        ...
        A = (P, b) =>
          P.replace(/\{\$([^:]+):(.*?)\}/g, (d, s, f) => String(b[s] || f)),
        w = (P) => {
  ...
  wl = { class: "zero-code-tab-content" },
  zl = /* @__PURE__ */ _e({
    __name: "PreviewPanel",
    props: {
      editablePageData: { type: Array },
  ...
  Al = { class: "zero-code-modal-header" },
  Pl = { class: "zero-code-modal-body" },
  El = { class: "zero-code-img-file-input-section" },
  _l = {
    key: 0,
    class: "zero-code-img-file-info",
  },
  Cl = { class: "zero-code-img-file-preview" },
  Sl = ["src"],
  Il = { class: "zero-code-img-file-details" },
  Tl = { class: "zero-code-form-section" },
  Dl = { class: "zero-code-form-group" },
  Nl = ["disabled"],
  kl = { class: "zero-code-form-group" },
  Ml = ["disabled"],
  Ol = {
    key: 0,
    class: "zero-code-form-group",
  ...
  Fl = ["disabled"],
  Rl = { class: "zero-code-modal-footer" },
  Ll = ["disabled"],
  xl = /* @__PURE__ */ _e({
    ...
    setup(e, { emit: o }) {
      const t = e,
        ...
        l = ne(""),
        h = ne(t.componentId || ""),
        E = de(() => n.value && v.value.trim() && l.value.trim()),
        A = (i) => {
          const c = i.target;
        ...
        w = (i) => {
          i.preventDefault(),
            i.dataTransfer &&
              ...
              P(i.dataTransfer.files[0]);
        },
        P = (i) => {
          (n.value = i),
            (v.value = i.name.replace(/\.[^/.]+$/, "")),
            (l.value = i.name),
            m.value && URL.revokeObjectURL(m.value),
            (m.value = URL.createObjectURL(i));
        },
        b = (i) =>
          new Promise((c, p) => {
        ...
        s = (i) => {
          ...
          const c = 1024,
            p = ["Bytes", "KB", "MB", "GB"],
            $ = Math.floor(Math.log(i) / Math.log(c));
                      ...
                      ? (D(),
                        N("div", _l, [
                          ...
                          g("div", Il, [
                            g("p", null, [
                              c[10] ||
                                (c[10] = g("strong", null, "ファイル名:", -1)),
                              jt(" " + H(n.value.name), 1),
                            ]),
                            g("p", null, [
                              c[11] ||
                                (c[11] = g("strong", null, "サイズ:", -1)),
                              jt(" " + H(s(n.value.size)), 1),
                            ]),
                            g("p", null, [
                              c[12] ||
                                (c[12] = g("strong", null, "タイプ:", -1)),
                              jt(" " + H(n.value.type), 1),
                            ]),
                          ]),
                        ]))
  ...
  Hl = { class: "zero-code-modal-body" },
  Vl = { class: "zero-code-img-detail-preview" },
  Zl = ["src", "alt"],
  jl = { class: "zero-code-form-section" },
  Ul = { class: "zero-code-form-group" },
  Wl = { class: "zero-code-form-group" },
  Xl = {
    key: 0,
    class: "zero-code-form-group",
  },
  Yl = { class: "zero-code-img-detail-info" },
  Kl = { class: "zero-code-img-detail-info-group" },
  Jl = { class: "zero-code-img-detail-info-group" },
  ql = { class: "zero-code-img-detail-info-group" },
  Gl = { class: "zero-code-img-detail-info-group" },
  Ql = { class: "zero-code-img-detail-info-group" },
  ed = { class: "zero-code-img-detail-url-group" },
  td = { class: "zero-code-modal-footer" },
  od = { class: "zero-code-modal-footer-right" },
  rd = /* @__PURE__ */ _e({
    ...
    setup(e, { emit: o }) {
      const t = e,
        ...
        h = async (b) => {
          ...
          if (
            !confirm(
              `画像を "${s.name}" に差し替えますか？この操作は取り消せません。`
            )
          ) {
            d.value = "";
            return;
        ...
        w = (b) => {
          ...
          const d = 1024,
            s = ["Bytes", "KB", "MB", "GB"],
            f = Math.floor(Math.log(b) / Math.log(d));
          return parseFloat((b / Math.pow(d, f)).toFixed(2)) + " " + s[f];
        },
        P = (b) =>
          new Date(b).toLocaleString("ja-JP", {
            year: "numeric",
            month: "2-digit",
            day: "2-digit",
            hour: "2-digit",
                    ...
                    g("div", Yl, [
                      g("div", Kl, [
                        ...
                        g(
                          ...
                          H(n.category === "common" ? "共通画像" : "個別画像"),
                          3
                        ),
                      ]),
                      g("div", Jl, [
                        d[14] ||
                          (d[14] = g("label", null, "ファイルサイズ:", -1)),
                        g("span", null, H(w(n.size)), 1),
                      ]),
                      g("div", ql, [
                        d[15] ||
                          (d[15] = g("label", null, "ファイルタイプ:", -1)),
                        g("span", null, H(n.type), 1),
                      ]),
                      g("div", Gl, [
                        d[16] ||
                          (d[16] = g("label", null, "アップロード日時:", -1)),
  ...
  nd = { class: "zero-code-tab-content" },
  ad = { class: "zero-code-data-tabs" },
  sd = ["onClick"],
  id = { class: "zero-code-image-content" },
  ld = {
    key: 0,
    class: "zero-code-image-section",
  },
  dd = { class: "zero-code-section-header" },
  cd = { class: "zero-code-img-grid" },
  ud = ["onClick"],
  pd = ["src", "alt"],
  fd = { class: "zero-code-img-info" },
  md = { class: "zero-code-img-name" },
  gd = { class: "zero-code-img-size" },
  hd = ["onClick"],
  vd = {
    key: 0,
    class: "zero-code-empty-state",
  ...
  bd = { class: "zero-code-section-header" },
  $d = { class: "zero-code-img-grid" },
  wd = ["onClick"],
  zd = ["src", "alt"],
  Ad = { class: "zero-code-img-info" },
  Pd = { class: "zero-code-img-name" },
  Ed = { class: "zero-code-img-size" },
  _d = ["onClick"],
  Cd = {
    key: 0,
    class: "zero-code-empty-state",
  },
  Sd = { class: "zero-code-debug-info" },
  Id = /* @__PURE__ */ _e({
    ...
    setup(e, { emit: o }) {
      const t = e,
        ...
        l = ne("common"),
        h = ne(null),
        E = de(() => t.commonImages.length + t.individualImages.length),
        A = ["common", "individual"],
        w = (z) =>
          ({
            common: "共通画像",
        ...
        P = (z) => {
          ...
          const C = 1024,
            u = ["Bytes", "KB", "MB", "GB"],
            y = Math.floor(Math.log(z) / Math.log(C));
        ...
        c = (z, C) => {
          if (C.category === "common") {
            const y = t.commonImages.map((_) => (_.id === z ? C : _));
            r("updateCommonImages", y);
          } else {
            const y = t.individualImages.map((_) => (_.id === z ? C : _));
      ...
      return (z, C) => (
        ...
        N("div", nd, [
                ...
                N("div", ld, [
                  g("div", dd, [
                    g(
                      "h4",
                      null,
                      "共通画像 (" + H(z.commonImages.length) + "件)",
                      1
                    ),
                    g(
                      "button",
                ...
                N("div", yd, [
                  g("div", bd, [
                    g(
                      "h4",
                      null,
                      "個別画像 (" + H(z.individualImages.length) + "件)",
                      1
                    ),
                    g(
                      "button",
          ...
          g("div", Sd, [
            ...
            jt(
              " 共通画像: " +
                H(z.commonImages.length) +
                "件, 個別画像: " +
                H(z.individualImages.length) +
                "件, 合計: " +
                H(E.value) +
                "件 ",
              1
...
function Td() {
  const e = ne("editor"),
    o = (h) => {
      e.value !== h &&
        (I.info(`🔄 タブ切り替え: ${e.value} → ${h}`), (e.value = h));
    };
  return {
    // 状態
    activeTab: e,
...
function Dd(e) {
  const o = ao({
    ...
    t = {
      ...
      currentComponentIndex: de(() =>
        o.selectedComponentIndex === null
          ? -1
          : typeof o.selectedComponentIndex == "number"
          ? o.selectedComponentIndex
          : parseInt(o.selectedComponentIndex.toString())
      ),
      // 編集可能なページデータの長さ
    ...
    n = {
      openEditor: (l, h) => {
        (o.selectedComponent = l),
          (o.selectedComponentIndex = h),
          (o.showEditor = !0);
      },
      closeEditor: () => {
        (o.showEditor = !1),
      ...
      openNestedPartSelector: (l, h) => {
        (o.nestedInsertPath = l),
          (o.nestedInsertPosition = h),
          (o.showNestedPartSelector = !0);
      },
    ...
    v = () => {
      (o.editablePageData = Array.isArray(e.page) ? [...e.page] : []),
        (o.localParts = Array.isArray(e.parts) ? [...e.parts] : []),
        (o.localCommonParts = Array.isArray(e.commonParts)
          ? [...e.commonParts]
          : []),
        (o.localIndividualParts = Array.isArray(e.individualParts)
          ? [...e.individualParts]
          : []);
    };
  return (
...
function Nd() {
  const e = (l) =>
    l.includes("url") || l.includes("src") || l.includes("link")
      ? "url"
      : l.includes("email")
      ? "email"
      : l.includes("number") || l.includes("count")
      ? "number"
      : l.includes("date")
      ? "date"
      : l.includes("time")
      ...
      : l.includes("password")
      ? "password"
      : l.includes("tel") || l.includes("phone")
      ? "tel"
      : "text";
  return {
    // 基本ユーティリティ
    ...
    formatFileSize: (l) => {
      ...
      const h = 1024,
        E = ["Bytes", "KB", "MB", "GB"],
        A = Math.floor(Math.log(l) / Math.log(h));
...
function kd() {
  let e = null;
  const o = (p) => {
      if (!p || typeof p != "string" || p.trim() === "") return "<p></p>";
      ...
      const u = (_) => {
        ...
        if (!$.includes(S)) {
          ...
          if (T) {
            for (; _.firstChild; ) T.insertBefore(_.firstChild, _);
            T.removeChild(_);
          }
          return;
        }
    ...
    t = () => {
      ...
      return e != null && e.contains($.commonAncestorContainer)
        ? { selection: p, range: $ }
    ...
    A = (p, $) => {
      ...
      if (
        z != null &&
        z.rangeCount &&
        e.contains(z.getRangeAt(0).commonAncestorContainer)
      ) {
    ...
    P = (p) => {
      ...
      let C = z.commonAncestorContainer;
      for (
        C.nodeType === window.Node.TEXT_NODE && (C = C.parentElement || C);
        C && C !== e;

      ) {
        if (
          C.nodeType === window.Node.ELEMENT_NODE &&
          C.tagName.toLowerCase() === p.toLowerCase()
        )
          return !0;
        C = C.parentElement;
      }
  ...
  `,
    ...
    s = (p, $) => {
      ...
      p.addEventListener("focus", () => {
        ...
        p.addEventListener("keydown", (y) => {
          ...
          if (y.key === "Enter" && !y.shiftKey) {
            ...
            let L = null;
            if (
              (M.nodeType === window.Node.TEXT_NODE
                ? (L =
                    ((_ = M.parentElement) == null ? void 0 : _.closest("p")) ||
                    null)
                : M.nodeType === window.Node.ELEMENT_NODE &&
                  (L = M.closest("p") || null),
              L)
            ) {
          ...
          z && window.clearTimeout(z),
            (z = window.setTimeout(() => {
              ...
              if (y !== p.innerHTML) {
                ...
                let S = null;
                if (
                  (_ && _.rangeCount > 0 && (S = _.getRangeAt(0).cloneRange()),
                  (p.innerHTML = y),
                  S && _)
                )
                  try {
      ...
      return (
        u.observe(p, { childList: !0, subtree: !0, characterData: !0 }),
        { saveTimeout: z, updateTimeout: C, observer: u }
      );
    },
    f = (p, $, z) => {
...
class Md {
  ...
  emit(o, t) {
    ...
    r.forEach((m) => {
      ...
      n.length > 0 &&
        Promise.allSettled(n).then((m) => {
          m.forEach((v, l) => {
            v.status === "rejected" &&
              I.error(`EventBus: ${o} 非同期リスナー[${l}]でエラー`, v.reason);
          });
        });
  }
  /**
  ...
  getListenerCount(o) {
    var r;
    if (o) return ((r = this.events.get(o)) == null ? void 0 : r.size) || 0;
    let t = 0;
    return (
...
const Ee = new Md(),
  et = {
     ...
     * リッチテキスト編集開始（レガシー）
     */
    startRichTextEdit: (e, o, t) =>
      Ee.emit("startRichTextEdit", {
        componentId: e,
        paramName: o,
        currentValue: t,
      }),
  ...
  const t = Dd(e),
    ...
    l = (d, s, f) => {
      for (let a = 0; a < d.length; a++) {
        const i = d[a];
        if (i.id === s) return (d[a] = f), !0;
        if (
          i.nested_parts &&
          Array.isArray(i.nested_parts) &&
          l(i.nested_parts, s, f)
        )
          return !0;
            ...
            for (const $ of p)
              if ($ && typeof $ == "object") {
                for (const [z, C] of Object.entries($))
                  if (Array.isArray(C) && l(C, s, f)) return !0;
              }
          }
      }
      return !1;
    ...
    h = (d, s) => {
      for (let f = 0; f < d.length; f++) {
        if (d[f].id === s) return d.splice(f, 1), !0;
        if (
          d[f].nested_parts &&
          Array.isArray(d[f].nested_parts) &&
          h(d[f].nested_parts, s)
        )
          return !0;
    ...
    E = {
      ...
      duplicatePart: (d) => {
        ...
        if (s) {
          const f = r.component.duplicateComponent(s),
            a = [...t.editablePageData.value];
          a.splice(d + 1, 0, f),
            (t.editablePageData.value = a),
            o("update:page", a);
        }
      },
      // 並べ替え操作
      ...
      reorderNestedParts: (d, s) => {
        const f = r.string.parseHierarchyPath(d),
          a = JSON.parse(JSON.stringify(t.editablePageData.value)),
          i = r.component.findComponentByPath(a, f);
        i &&
          ((i.nested_parts = [...s]),
          (t.editablePageData.value = a),
          o("update:page", a));
      ...
      moveNestedPart: (d, s, f) => {
        const a = r.string.parseHierarchyPath(d),
          i = JSON.parse(JSON.stringify(t.editablePageData.value)),
          c = r.component.findComponentByPath(i, a);
        if (
          c != null &&
          c.nested_parts &&
          c.nested_parts.length > Math.max(s, f)
        ) {
      ...
      moveNestedPartBetweenLevels: (d, s, f, a) => {
        const i = r.string.parseHierarchyPath(d),
          c = r.string.parseHierarchyPath(f),
          p = [...t.editablePageData.value],
          $ = r.component.findComponentByPath(p, i);
        if (!($ != null && $.nested_parts)) return;
        const [z] = $.nested_parts.splice(s, 1),
          C = r.component.findComponentByPath(p, c);
        C &&
          (C.nested_parts || (C.nested_parts = []),
          C.nested_parts.splice(a, 0, z),
          (t.editablePageData.value = p),
          o("update:page", p));
      },
      // コンポーネントIDベースのネストパーツ並べ替え
      moveNestedPartById: (d, s, f) => {
        const a = JSON.parse(JSON.stringify(t.editablePageData.value)),
          i = v(a, d);
        if (
          i != null &&
          i.nested_parts &&
          i.nested_parts.length > Math.max(s, f)
        ) {
      ...
      moveNestedPartBetweenLevelsById: (d, s, f, a) => {
        const i = JSON.parse(JSON.stringify(t.editablePageData.value)),
          c = v(i, d);
        if (!(c != null && c.nested_parts)) return;
        const [p] = c.nested_parts.splice(s, 1),
          $ = v(i, f);
        $ &&
          ($.nested_parts || ($.nested_parts = []),
          $.nested_parts.splice(a, 0, p),
          (t.editablePageData.value = i),
          o("update:page", i));
      },
      // z-for内のネストパーツ並べ替え
      moveZForNestedPart: (d, s, f) => {
        ...
        const [, i, c, p, $] = a,
          z = parseInt(p),
          C = JSON.parse(JSON.stringify(t.editablePageData.value)),
          u = v(C, i);
        if (!u) return;
        const y = u[c];
        if (!Array.isArray(y) || z >= y.length) return;
        const _ = y[z];
        if (!_ || !_[$] || !Array.isArray(_[$])) return;
        const S = _[$];
        if (s < 0 || s >= S.length || f < 0 || f >= S.length || s === f) return;
      ...
      deleteNestedPart: (d) => {
        if (window.confirm("このネストパーツを削除しますか？")) {
          const s = JSON.parse(JSON.stringify(t.editablePageData.value)),
            f = /^(.+)\.(.+)\[(\d+)\]\.(.+)\[(\d+)\]$/,
            a = d.match(f);
          let i = !1;
          if (a) {
      ...
      // 配列操作
      addArrayItem: (d, s) => {
        r.component.addArrayItem(d, s),
          o("update:page", t.editablePageData.value);
      },
      removeArrayItem: (d, s, f) => {
        r.component.removeArrayItem(d, s, f),
          o("update:page", t.editablePageData.value);
      },
      // データリセット
      resetPageData: () => {
        (t.editablePageData.value = Array.isArray(e.page) ? [...e.page] : []),
          o("update:page", t.editablePageData.value);
      },
      resetPartsData: () => {
        (t.localParts.value = Array.isArray(e.parts) ? [...e.parts] : []),
          o("update:parts", t.localParts.value);
      },
    },
    A = {
      ...
      currentTemplate: de(() => {
        ...
        return d
          ? r.template.getTemplate(d.type, d.module_name, t.localParts.value)
          : "";
      }),
      // 現在のフィールド一覧
      currentFields: de(() => {
      ...
      // レンダリング関数
      renderComponent: (d) =>
        n.renderComponentWithoutSlot(d, (s, f) =>
          r.template.getTemplate(s, f, t.localParts.value)
        ),
      // パーツ管理用プレビュー
      renderPartPreview: (d) => {
        if (!d) return "";
        try {
          ...
          return (
            ...
            (s = s.replace(
              /\(\$([^:]+):([^)]+)\)/g,
              (f, a, i) => i.split("|").filter((p) => p.trim())[0] || ""
            )),
            (s = s.replace(/\(\$([^:?]+)\?:([^)]*)\)/g, (f, a, i) => i || "")),
            (s = s.replace(/z-slot="[^"]*"/g, "")),
            (s = s.replace(/z-for="[^"]*"/g, "")),
            (s = s.replace(/z-for-wrapper="[^"]*"/g, "")),
            s
          );
        } catch {
          return d;
    ...
    w = () => {
      Ee.on("addArrayItem", ({ componentId: d, arrayKey: s }) => {
        try {
          if (
            (I.debug(
              `EventBus: addArrayItem - componentId=${d}, arrayKey=${s}`
            ),
            !d || !s)
          )
            throw new Error("componentId または arrayKey が指定されていません");
          const f = v(t.editablePageData.value, d);
          if (!f) throw new Error(`Component not found: ${d}`);
          I.success(`Component found: ${f.id}, adding array item to ${s}`);
          const a =
            t.localParts.value && t.localParts.value.length > 0
              ? t.localParts.value
              : [];
          a.length > 0 ? no(a).addArrayItem(f, s) : E.addArrayItem(f, s),
            o("update:page", t.editablePageData.value);
        } catch (f) {
          I.error(`配列アイテム追加エラー: ${f}`, {
            componentId: d,
            arrayKey: s,
          });
        }
            ...
            try {
              ...
              const i =
                  t.localParts.value && t.localParts.value.length > 0
                    ...
                    : [],
                c = no(i),
                p = c.getTemplate(a.type, a.module_name),
                $ = {
        ...
        Ee.on(
          "removeZForArrayItem",
          ({ componentId: d, arrayName: s, index: f }) => {
            try {
              I.debug(
              ...
              i.splice(f, 1),
                I.success(`z-for配列アイテム削除完了: ${s}[${f}]`),
                o("update:page", t.editablePageData.value);
            } catch (a) {
              I.error(`z-for配列アイテム削除エラー: ${a}`, {
                componentId: d,
                arrayName: s,
                index: f,
              });
          ...
          ({ componentId: d, arrayName: s, fromIndex: f, toIndex: a }) => {
            try {
              ...
              if (
                ...
                throw new Error(
                  `Invalid array or indices: ${s}[${f}] -> [${a}]`
                );
              ...
              if ($) {
                ...
                z.splice(a, 0, C),
                  ...
                  o("update:page", p),
                  I.success(
                    `z-for配列アイテム並び替え完了: ${s}[${f}] -> [${a}]`
                  );
              } else throw new Error(`Component not found in new data: ${d}`);
            } catch (i) {
          ...
          ({ componentId: d, arrayName: s, index: f }) => {
            try {
              ...
              I.debug("z-for配列アイテム編集: コンポーネント検索結果", {
                ...
                t.openEditor(p, `${d}_${s}_${f}`),
                I.success(`z-for配列アイテム編集開始: ${s}[${f}]`);
            } catch (a) {
              I.error(`z-for配列アイテム編集エラー: ${a}`, {
                componentId: d,
                arrayName: s,
                index: f,
              });
        ...
        Ee.on("deleteNestedPart", ({ pathString: d }) => {
          I.debug(`EventBus: deleteNestedPart - path=${d}`),
            E.deleteNestedPart(d);
        }),
        Ee.on("openNestedEditor", ({ pathString: d }) => {
          if (
            (I.debug(`EventBus: openNestedEditor - path=${d}`),
            !d || typeof d != "string")
          ) {
          ...
          if (f) {
            ...
            if (C && C[c] && Array.isArray(C[c])) {
              ...
              u &&
                ...
                Array.isArray(u[$]) &&
                ((a = u[$][parseInt(z)]),
                I.debug("z-for内ネストパーツを発見:", a));
            }
          } else a = v(t.editablePageData.value, d);
          a
            ? (I.debug("Found component:", {
                id: a.id,
                type: a.type,
                module: a.module_name,
              }),
              t.openEditor(a, d))
            : I.error(`Component not found with ID: ${d}`);
        }),
        Ee.on("openNestedPartSelector", ({ pathString: d, position: s }) => {
          I.debug(
            `EventBus: openNestedPartSelector - path=${d}, position=${s}`
          ),
            t.openNestedPartSelector(d, s);
        });
    },
    P = (d) => {
      [
        ...
        (window.startTiptapEdit = d || E.startSimpleTiptapEdit),
        (window.stopTiptapEdit = E.stopTiptapEdit),
        (window.openPartSelector = (i) => t.openPartSelector(i)),
        (window.openNestedPartSelector = et.openNestedPartSelector),
        (window.openNestedEditor = et.openNestedEditor),
        (window.deleteNestedPart = et.deleteNestedPart),
        (window.addArrayItem = et.addArrayItem),
        (window.addZForArrayItem = et.addZForArrayItem),
        (window.removeZForArrayItem = et.removeZForArrayItem),
        (window.reorderZForArrayItem = et.reorderZForArrayItem),
        (window.editZForArrayItem = et.editZForArrayItem);
      let f = null,
        a = null;
      (window.handleZForDragStart = (i, c, p, $) => {
        ...
        (window.handleZForDragEnd = (i) => {
          const c = i.target,
            p = c.closest(".zero-code-z-for-item-wrapper");
          p
            ? ((p.style.opacity = "1"),
        ...
        (window.handleZForArrayItemDrop = (i) => {
          ...
          const $ =
              (p == null ? void 0 : p.getAttribute("data-component-id")) ||
              c.getAttribute("data-component-id"),
            z =
              (p == null ? void 0 : p.getAttribute("data-array-name")) ||
              c.getAttribute("data-array-name"),
            C =
              (p == null ? void 0 : p.getAttribute("data-item-index")) ||
              c.getAttribute("data-item-index"),
            u = parseInt(C || "0");
          f.componentId === $ &&
            f.arrayName === z &&
            f.index !== u &&
            (et.reorderZForArrayItem(f.componentId, f.arrayName, f.index, u),
        ...
        (window.handleNestedPartDragStart = (i) => {
          ...
          if (p) {
            const $ = p.getAttribute("data-nested-path"),
              z = p.getAttribute("data-slot-name"),
              C = p.getAttribute("data-part-index");
            $ &&
              z &&
              C !== null &&
              ((a = {
              ...
              (p.style.opacity = "0.5"),
              (i.dataTransfer.effectAllowed = "move"),
              i.dataTransfer.setData("text/html", p.outerHTML),
              I.debug("z-for nested part drag start", a));
          }
        }),
        (window.handleNestedPartDragEnd = (i) => {
          const p = i.target.closest(".z-for-nested-part");
          p && (p.classList.remove("dragging"), (p.style.opacity = "1")),
            document
            ...
            (a = null),
            I.debug("z-for nested part drag end");
        }),
        ...
        (window.handleNestedPartDrop = (i) => {
          ...
          const c = i.currentTarget,
            p =
              c.closest(".z-for-nested-part") || c.closest(".nested-component");
          if ((p && p.classList.remove("drag-over"), !a)) {
            I.warn("No dragged nested part found");
            return;
          }
          const $ = c.getAttribute("data-slot-name"),
            z = c.getAttribute("data-part-index");
          if ($ && z !== null) {
            const C = parseInt(z);
            if ($ === a.slotName) {
...
const Fd = { class: "zero-code-tab-navigation" },
  Rd = ["onClick"],
  Ld = /* @__PURE__ */ _e({
    ...
    setup(e) {
      const o = ["editor", "preview", "parts", "images"],
        t = (r) =>
          ({
            editor: "エディタ",
            preview: "ページプレビュー",
...
const Bd = { class: "zero-code-error-boundary" },
  Hd = {
    key: 0,
    class: "zero-code-error-notifications",
  },
  Vd = { class: "zero-code-error-content" },
  Zd = { class: "zero-code-error-message" },
  jd = { class: "zero-code-error-icon" },
  Ud = { class: "zero-code-error-text" },
  Wd = ["onClick"],
  Xd = {
    key: 0,
    class: "zero-code-error-details",
  },
  Yd = { class: "zero-code-error-details-pre" },
  Kd = { class: "zero-code-error-boundary-content" },
  Jd = /* @__PURE__ */ _e({
    ...
    setup(e) {
      const { errors: o, hasErrors: t, clearError: r } = xd(),
        n = (v) => {
          switch (v) {
      ...
      return (v, l) => (
        ...
        N("div", Bd, [
          G(t)
                    ...
                    (h) => (
                      ...
                      N(
                        ...
                        [
                          ...
                          h.details && v.showDetails
                            ? (D(),
                              N("div", Xd, [g("pre", Yd, H(h.details), 1)]))
                            : Y("", !0),
                        ],
                        2
                      )
            ...
            : Y("", !0),
          g("div", Kd, [qr(v.$slots, "default")]),
        ])
      );
    },
  }),
  qd = { class: "zero-code-toolbar-content" },
  Gd = { class: "zero-code-toolbar-section" },
  Qd = {
    key: 0,
    class: "zero-code-toolbar-separator",
  },
  ec = ["title", "disabled", "onClick"],
  tc = { class: "zero-code-toolbar-section" },
  oc = /* @__PURE__ */ _e({
  ...
  rc = { class: "zero-code editor-container" },
  nc = { class: "zero-code-editor-content" },
  ac = /* @__PURE__ */ _e({
    __name: "ZeroCode.ce",
    props: {
    ...
    setup(e, { emit: o }) {
      const t = e,
        r = o,
        n = Od(t, r),
        m = n.state.selectedComponent;
      n.state.selectedComponentIndex;
      const v = n.state.editablePageData,
        l = n.state.localParts,
        h = n.state.dataTab,
        E = ne(!1),
        A = ne({ top: 0, left: 0 }),
        w = ne(null),
        ...
        c = () => {
          ...
          const O = w.value.innerHTML,
            B = i(O),
            j = (oe) => {
              const J = b.value.match(/^(.+)_(.+)_(\d+)_(.+)$/);
              if (J) {
                const [me, ve, ce, Q, be] = J,
                  pe = (Pe, Te) => {
                    for (const ct of Pe) {
                      if (ct.id === Te) return ct;
                ...
                if (ge && Array.isArray(ge[ce])) {
                  ...
                  if (Pe && typeof Pe == "object") return (Pe[be] = B), !0;
                }
                return !1;
              }
              for (const me of oe) {
                if (me.id === b.value) return (me[d.value] = B), !0;
                if (
                  me.nested_parts &&
                  Array.isArray(me.nested_parts) &&
                  j(me.nested_parts)
                )
                  return !0;
                  ...
                  if (Array.isArray(ce) && ve !== "nested_parts") {
                    for (const Q of ce)
                      if (Q && typeof Q == "object") {
                        if (Q.id === b.value) return (Q[d.value] = B), !0;
                        for (const [be, pe] of Object.entries(Q))
                          if (Array.isArray(pe) && j(pe)) return !0;
                      }
                  }
              }
              return !1;
          ...
          j(v.value) &&
            (w.value && O !== B && (w.value.innerHTML = B),
            r("update:page", v.value));
        },
        p = (O) => {
          w.value &&
            (O ? c() : (w.value.innerHTML = P.value),
        ...
        y = () => {
          ...
          const oe = (ce) => {
              ...
              if (be.classList.contains("draggable-nested")) {
                ...
                if (be.classList.contains("z-for-nested-part")) return;
                B = be;
                const pe = be.dataset.componentId || "",
                  ge = be.dataset.path || "",
                  Pe = be.dataset.parentPath || "",
                  Te = parseInt(be.dataset.index || "0");
                (j = { componentId: pe, path: ge, parentPath: Pe, index: Te }),
                  Q.dataTransfer &&
                    ((Q.dataTransfer.effectAllowed = "move"),
                    Q.dataTransfer.setData("text/plain", "nested-component")),
            ...
            J = (ce) => {
              const Q = ce;
              Q.preventDefault(),
                Q.dataTransfer && (Q.dataTransfer.dropEffect = "move");
            },
            me = (ce) => {
              const Q = ce;
              ...
              if (pe && pe !== B) {
                const ge = pe.dataset.parentPath || "",
                  Pe = parseInt(pe.dataset.index || "0");
                j.parentPath === ge &&
                  n.actions.moveNestedPartById(j.parentPath, j.index, Pe);
              }
              B && (B.style.opacity = "1"), (B = null), (j = null);
            },
            ve = (ce) => {
              const Q = ce.target;
              Q.classList.contains("draggable-nested") &&
                (Q.style.opacity = "1"),
                (B = null),
                (j = null);
            };
          return (
            O.addEventListener("dragstart", oe),
            O.addEventListener("dragover", J),
            O.addEventListener("drop", me),
            O.addEventListener("dragend", ve),
            () => {
              O.removeEventListener("dragstart", oe),
                O.removeEventListener("dragover", J),
                O.removeEventListener("drop", me),
                O.removeEventListener("dragend", ve);
            }
          );
        },
        _ = () => {
        ...
        U = (O, B) => {
          ...
          return (
            j === void 0 &&
              ((j = v.value.findIndex((oe) => oe.id === O.id)),
              j === -1 && (j = 0)),
            n.templateProcessor.renderComponentWithNested(
              O,
              j,
              // 実際のコンポーネントインデックスを渡す
              ...
              (oe, J, me, ve) =>
                n.templateProcessor.renderNestedComponentsWithUI(
                  oe,
                  J,
                  (ce) => ce.join("-"),
                  // パス配列を文字列に変換
                  ve ||
                    ((ce, Q) => n.utils.template.getTemplate(ce, Q, l.value))
                )
            )
          );
        },
        ...
        te = (O) => {
          const { type: B, title: j, body: oe, category: J = "common" } = O,
            me = [...l.value];
          ...
          if (k.value) {
            ...
            Q !== -1 && (ve.module[Q] = ce);
          } else ve.module.push(ce);
          (l.value = me), r("update:parts", me), xt();
        },
        { activeTab: le, switchToTab: Re } = Td(),
        Ve = n.state.showPartSelector,
        Ae = n.state.showNestedPartSelector,
        Ze = ne(!1),
        Ge = (O) => {
        ...
        Lo = async () => {
          try {
            ...
            if (O.ok && B.ok) {
              ...
              (Qe.value = Array.isArray(j) ? j : []),
                (Le.value = Array.isArray(oe) ? oe : []);
            } else (Qe.value = []), (Le.value = []);
          } catch {
            (Qe.value = []), (Le.value = []);
          }
        },
        Lr = (O, B, j) => {
          const oe = at.value.createNewComponent(O, B),
            J = j !== void 0 ? j : n.state.insertPosition.value;
          n.actions.addPart(oe, J), Lt();
        },
        xr = (O, B) => {
          const j = n.state.nestedInsertPath.value,
            oe = n.state.nestedInsertPosition.value,
            J = at.value.createNewComponent(O, B);
        ...
        Br = (O) => at.value.getFieldInfo(O),
        Hr = (O, B, j) => at.value.shouldShowBasicField(O, B, j),
        Vr = (O, B, j) => at.value.shouldShowArrayField(O, B, j),
        Zr = (O, B, j, oe, J) =>
          at.value.shouldShowArrayItemField(O, B, j, oe, J),
        jr = (O) => at.value.getInputType(O),
        Ur = (O, B, j) => at.value.isCheckboxChecked(O, B, j),
        Wr = (O, B) => {
          const j = m.value;
          if (j) {
            if (((j[O] = B), j._isZForItem)) {
              const oe = j._parentComponentId,
                J = j._arrayName,
                me = j._arrayIndex,
                ve = (Q, be) => {
                  for (const pe of Q) {
                    if (pe.id === be) return pe;
      ...
      const xo = (O) => {
        ...
        const B = O.target;
        B.closest(".zero-code-rich-text-toolbar") ||
          B === w.value ||
          w.value.contains(B) ||
          p(!0);
      };
      ...
      return (
        To(async () => {
          await Lo(),
            document.addEventListener("click", xo),
            n.setupEventListeners(),
            n.exposeGlobalFunctions((O, B) => {
              (E.value = !0), n.actions.startTiptapEdit(O, B, [], 0);
            }),
            (co = y() || null),
            (window.startRichTextEdit = async (O, B, j, oe) => {
              var me;
              const J =
                oe || ((me = window.event) == null ? void 0 : me.target);
              if (w.value !== J && J) {
                w.value && p(!1),
                  (w.value = J),
                  (P.value = J.innerHTML),
                  ...
                  J.classList.add("editing");
                const ve = (pe) => {
                  const ge = pe.relatedTarget;
                  (ge && ge.closest(".zero-code-rich-text-toolbar")) ||
                    setTimeout(() => {
                      w.value === J && p(!0);
                    }, 150);
                };
                J.addEventListener("blur", ve),
                  (J._cleanup = () => {
                    J.removeEventListener("blur", ve);
                  });
                const ce = J.getBoundingClientRect(),
                  Q = window.pageYOffset || document.documentElement.scrollTop,
                  be =
                  ...
                  setTimeout(() => {
                    ...
                    if (J && w.value === J) {
                      ...
                      if (Pe && J.childNodes.length > 0) {
                        ...
                        Te.nodeType === Node.TEXT_NODE
                          ? ge.setStart(
                              Te,
                              ((pe = Te.textContent) == null
                                ? void 0
                                : pe.length) || 0
                            )
                          : ge.setStartAfter(Te),
                    ...
                    ? (D(),
                      Be(
                        xs,
                        {
                          ...
                          "local-parts": G(l),
                          "local-common-parts":
                            G(n).state.localCommonParts.value,
                          "local-individual-parts":
                            G(n).state.localIndividualParts.value,
                          parts: t.parts || [],
...
export { sc as ZeroCode, sc as default };
